...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        button:hover, .button-link:hover { background: var(--surface-soft); text-decoration: none; }
        ...
        .topbar { min-height: 48px; display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 10px 20px; background: #243041; color: #fff; box-shadow: var(--shadow); }
        ...
        .success { background: var(--green-soft); border-color: #bbf7d0; color: #065f46; }
        .error { background: #fef2f2; border-color: #fecaca; color: #991b1b; }
        .notice { background: #eff6ff; border-color: #bfdbfe; color: #1e3a8a; }
        .warning { background: var(--yellow-soft); border-color: #fde68a; color: var(--yellow); }
        ...
        .card, .panel, .operation-area { background: var(--surface); border: 1px solid var(--border); border-radius: 6px; box-shadow: var(--shadow); }
        .card { padding: 16px; margin: 14px 0; }
        .actions { display: flex; flex-wrap: wrap; gap: 8px; align-items: center; }
        .mini-form { margin: 0; }
        .inline-check { display: flex; gap: 6px; align-items: center; margin: 0; font-weight: 400; }
        .split-note { font-size: 12px; color: var(--muted); }
        .empty-state { color: var(--muted); padding: 18px; text-align: center; background: var(--surface-soft); border: 1px dashed var(--border-strong); border-radius: 6px; }
        ...
        .summary-strip { display: grid; grid-template-columns: repeat(5, minmax(130px, 1fr)); gap: 10px; margin-bottom: 14px; }
        .summary-item { background: var(--surface); border: 1px solid var(--border); border-radius: 6px; padding: 11px 12px; box-shadow: var(--shadow); }
        ...
        .area-grid { display: grid; grid-template-columns: minmax(0, 1.4fr) minmax(320px, .8fr); gap: 14px; align-items: start; }
        .area-column { display: flex; flex-direction: column; gap: 14px; }
        .operation-area { overflow: hidden; }
        .area-header { display: flex; justify-content: space-between; align-items: center; gap: 10px; padding: 11px 12px; border-bottom: 1px solid var(--border); background: var(--surface-soft); }
        .area-heading { display: flex; align-items: center; gap: 9px; }
        .area-no { width: 24px; height: 24px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; background: var(--blue-soft); color: #1d4ed8; font-size: 12px; font-weight: 700; }
        .area-body { padding: 12px; }
        .area-description { margin: 0 0 12px; color: var(--muted); }
        .section-block + .section-block, .sidebar-section + .sidebar-section { margin-top: 18px; }
        ...
        .workflow-steps { display: grid; grid-template-columns: repeat(4, minmax(130px, 1fr)); gap: 8px; }
        .workflow-step { padding: 9px 10px; border: 1px solid #c7d2fe; border-radius: 5px; background: #fff; color: #1f2937; }
        .workflow-step span { display: block; color: var(--muted); font-size: 12px; }
        .danger-zone { border-top: 1px solid var(--border); padding-top: 12px; }
        ...
        @media (max-width: 820px) {
            ...
            .workbench-header, .summary-strip, .workflow-steps { grid-template-columns: 1fr; }
